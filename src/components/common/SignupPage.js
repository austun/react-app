                ...
                <div className="col-md-4 offset-md-4">
                    <form onSubmit={this.onSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <input type="password" className="form-control" name="passwordConfirmation" value={passwordConfirmation} onChange={this.onChange} />
                        </div>
                        <div className="form-group">
...
export default connect(null, {loginSuccess})(SignupPage);